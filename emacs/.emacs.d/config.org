...
#+BEGIN_SRC emacs-lisp
  (use-package eglot
    :config
    (add-to-list 'eglot-server-programs '(typescript-ts-mode . ("npx" "typescript-language-server" "--stdio"))))
#+END_SRC
**** Formatting
#+BEGIN_SRC emacs-lisp
  ...
  (use-package svelte-ts-mode
    ...
    (add-to-list 'treesit-language-source-alist
                 '(tsx "https://github.com/tree-sitter/tree-sitter-typescript"
                       nil "tsx/src"))
    (add-to-list 'eglot-server-programs '(svelte-ts-mode . ("npx" "svelte-language-server" "--stdio"))))
