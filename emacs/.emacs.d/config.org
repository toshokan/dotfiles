...
#+END_SRC
*** agenda
Get notifications for items in the org agenda
#+BEGIN_SRC emacs-lisp
...
*** Agenda
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-files '("~/Media/sync/org/agenda"))
#+END_SRC
* Functions
** Buffer management
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-agenda ()
    ...
    ("f" (counsel-find-file "~/Media/sync/org/agenda") "find" :color blue))
